...
export default function USP() {
  ...
  return (
    <div className="max-h-[60vh]">
      <div className="relative bg-gray-900/80 text-white px-6 py-24 sm:py-32 lg:px-8 overflow-hidden">
        <motion.div 
          style={{ y, backgroundImage: `url(${imageAssetUrl})` }}
          className="absolute top-0 left-0 w-full h-[800px] min-h-[600px] lg:min-h-[700px] bg-cover bg-top z-[-1]"
        />
        <motion.div 
